 ...
 */
export function fixtureSync<T extends Element>(template: import('./renderable').LitHTMLRenderable, options?: FixtureOptions): T;
/**
 * Renders a string/TemplateResult and puts it in the DOM via a fixtureWrapper.
 ...
 */
export function fixture<T extends Element>(template: import('./renderable').LitHTMLRenderable, options?: FixtureOptions): Promise<T>;
